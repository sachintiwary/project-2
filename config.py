...
Using gpt-5-mini via AI Pipe + Gemini 2.5 Flash for audio
"""
import os
...
# AI Pipe API settings (OpenAI-compatible with function calling)
OPENAI_BASE_URL = "https://aipipe.org/openai/v1"

# Model - using gpt-5-mini for advanced reasoning + tool calling
